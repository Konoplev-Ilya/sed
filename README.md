...
## read_all.sh
читаем из 2 журналов. опция -f к файлу с логинами и паролями, разделенными пробелом, по одной паре в строке. опциональные аргументы: дата (новее не читать. по умолчанию: 01.08.2021), количество документов в партии
